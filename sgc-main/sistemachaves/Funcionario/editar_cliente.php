...
<body>
    ...
    <main class="Main">
        ...
        <h1>Aula Prática de PHP - Editar Formação Professor</h1>
    <fieldset>
    ...
    <div>
        <fieldset>
            ...
            <table id="estudantes">
                ...
                <?php
                $acessos = getAcessos($id_cliente);
                foreach ($acessos as $acesso) {
                    echo '<tr>';
                    echo '<td>' . $acesso->id_acesso . '</td> ';
       
                    echo '<td>' . $acesso->id_chave . '</td> ';
