    ...
    <main class="Main">
                ...
                <form id="CadastroChaves" action="../Funcionario/PHP/GERENCIAMENTO/Chave.php"
                 method="POST">
                    ...
                    <div>
                        ...
                        <input type="number" name="idPredio" id="idPr'''''edio">
                    </div>
                    <div>
                        <label for="idChave">Descrição da chave: </label>
                        
                        <input type="text" name="DescriChave" id="DescriChave">
      ...
      $chaves = getChaves();
       foreach ($chaves as $chave) {
           ...
           echo "<td>" . $chave->id_predio . "</td>";
           echo "<td>" . $chave->descricao . "</td>";
           echo '<td>  <input type="reset" value="Editar"></td>';  
