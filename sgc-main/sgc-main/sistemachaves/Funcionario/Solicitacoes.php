      ...
      $agendars = getAgendamentosSolicitados();
       foreach ($agendars as $agendar) {
        ...
        echo "<div class=\"informacoes-pendente\">";
         ...
         echo "<h4>Requisição de: " . $agendar->nome . "</h4>";
         echo "<h4>Local: ". $agendar->descricao . "</h4>";
         echo "<h4>Data de emissão: ". $agendar->data_agendar . "</h4>";
         echo "<h4>Horário de início: ". $agendar->horario_inicio_agendar . "</h4>";
         echo "<h4>Horário de término: ". $agendar->horario_final_agendar . "</h4>";
         echo "</div>";
