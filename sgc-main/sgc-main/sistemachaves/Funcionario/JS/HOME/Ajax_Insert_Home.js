...
function GerenciamentoPredios(){
    ...
    function getChaves(){
        ...
        $.getJSON('./PHP/Gerenciamento/chave.php', function(chaves){
            ...
            var horas = ('0' + horaAtual.getHours()).slice(-2);
            var minutos = ('0' + horaAtual.getMinutes()).slice(-2);
            var segundos = ('0' + horaAtual.getSeconds()).slice(-2);
                                ...
                                $.each(chaves, function(indexChave, chavesLI){
                                    if (Li.className == ('idChave_'+chavesLI['idChave'])){
                                        ...
                                        buttonSubmitAgendarChave.addEventListener('click', (event)=>{ // Botão Salvar
                                            ...
                                            var situacao_Agendar = 1;
                                                    ...
                                                    $.ajax({
                                                        ...
                                                        data:{
                                                            ...
                                                            'horario_termino': $('#horario_termino').val(),
                                                            'situacao_agendar': situacao_Agendar,
                                                    ...
                                                    /* Erro */
                                                    console.error("Erro ao enviar requisição:", textStatus, errorThrown);
                                                }
                                            })
                                            ...
                                            //     },
                                            //     success: function(msg) {
                                            //         console.log("meu deeeeeeeeus deu certo:", msg);
