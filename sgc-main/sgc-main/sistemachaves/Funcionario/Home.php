            ...
            <form class="FormaAgendarChave" method="POST" id="FormaAgendarChave">
                ...
                <div>
                    ...
                    <div class="informacoes_agendamento">
                        ...
                        <div>
                            <label for="horario_agendamento">Entrada: </label>
                            <input type="time" name="horario_agendamento" id="horario_agendamento" >
                        </div>
                        <div>
                            <label for="horario_termino">Saída: </label>
...
/*
        $('#SubmitAgendarChave').click(function(){
